!function(t) {
    ...
    r.prototype.hitTestSimpleCustom = function(t, i, e, r) {
        return null !== this.live2DModel && i != null && (e >= t[0] && e <= i[0] && r <= t[1] && r >= i[1])
    }
    ,
...
, function(t, i, e) {
    ...
    function u(t) {
        Y = !0;
        var i = C.getBoundingClientRect(),sizeKey=(300/i.width)
          , e = P((t.clientX - i.left)*sizeKey)
          , r = S((t.clientY - i.top)*sizeKey)
          , o = $({
            x: i.left + i.width / 2,
            y: i.top + i.height * X
        }, {
          ...
          , n = m((o.x - i.left)*sizeKey)
          , s = T((o.y - i.top)*sizeKey);
...
, function(t, i, e) {
    ...
    o.prototype.setRandomExpression = function() {
        ...
        if(t.length==0)
        {
            console.warn("该角色没有表情！将播放 flick_head motion");
            this.startRandomMotion("flick_head", 3);
            return;
        }
